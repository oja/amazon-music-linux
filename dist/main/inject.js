...
var __am = {
    getMusicTitle: function () {
        ...
        setTimeout(function () {
            document.getElementsByClassName('playbackControls')[0].children[1].onclick = function () {
        ...
        setTimeout(function () {
            document.getElementsByClassName('playbackControls')[0].children[2].onclick = function () {
        ...
        setTimeout(function () {
            document.getElementsByClassName('playbackControls')[0].children[0].onclick = function () {
